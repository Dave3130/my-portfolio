			...
			<div className={classes.root}>
				<Grid container justify="center" spacing={isBig ? 10 : 5} style={{ "marginBottom": "2rem", padding: '2% 4%' }}>
					<Grid item xs={6} sm={6} md={3} align="center">
						...
						<Box p={1}>
							<img src={require('../assest/icons/eating.gif')} style={{ width: "11rem" }} />
						</Box>
						<Box flexWrap="wrap">
					...
					<Grid item xs={6} sm={6} md={3} align="center">
						...
						<Box p={1} >
							<img src={require('../assest/icons/coding.gif')} style={{ width: "10rem" }} />
						</Box>
						<Box flexWrap="wrap">
					...
					<Grid item xs={6} sm={6} md={3} align="center">
						...
						<Box p={1} >
							<img src={require('../assest/icons/sleeping.gif')} style={{ width: "12rem", borderRadius: "40px" }} />
						</Box>
						<Box flexWrap="wrap">
					...
					<Grid item xs={6} sm={6} md={3} align="center">
						...
						<Box p={1} >
							<img src={require('../assest/icons/repeating.gif')} style={{ width: "10rem" }} />
						</Box>
						<Box flexWrap="wrap">
